...
/**
 * POST /api/posts/[orgId]/[postId]/schedule — Schedule a post
 */
export async function POST(
  ...
  try {
    ...
    const res = await fetch(`${BACKEND_URL}/posts/${orgId}/${postId}/schedule`, {
      method: 'POST',
      headers: {
...
/**
 * DELETE /api/posts/[orgId]/[postId]/schedule — Cancel a scheduled post
 */
